...
public class Game {
    ...
    private void setupGame() {
        ...
        hemp.addRecipe(new Recipe(colorFactory, 1, 1,"worldofzuul/WorldOfZuulPNG/Icons/FabricWhiteIcon.png"));
        ...
        linen.addRecipe(new Recipe(colorFactory, 1, 1, "worldofzuul/WorldOfZuulPNG/Icons/FabricWhiteIcon.png"));
        ...
        bamboo.addRecipe(new Recipe(colorFactory, 2, 2, "worldofzuul/WorldOfZuulPNG/Icons/FabricWhiteIcon.png"));
        ...
        cotton.addRecipe(new Recipe(colorFactory, 2, 2, "worldofzuul/WorldOfZuulPNG/Icons/FabricWhiteIcon.png"));
        ...
        polyester.addRecipe(new Recipe(colorFactory, 2, 2, "worldofzuul/WorldOfZuulPNG/Icons/FabricWhiteIcon.png"));
